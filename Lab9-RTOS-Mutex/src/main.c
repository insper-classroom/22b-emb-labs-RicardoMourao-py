...
volatile uint muda_tempo = 0; // 0: n�o faz nada | 1: edita min | 2: edita hora
...
static void up_handler(lv_event_t *e)
{
  ...
  if (code == LV_EVENT_CLICKED)
  {
    /* Quando muda_tempo=1, altera minuto */
    if (muda_tempo == 1)
    {
    ...
    /* Quando muda_tempo=2, altera hora */
    ...
    /* Quando muda_tempo=0, altera temperatura */
    else if (muda_tempo == 0)
    {
...
void task_rtc(void *pvParameters)
{
  uint32_t hora_atual, min_atual, segundo_atual;
